...
google.data.date <- format(ymd("2021-07-23"), format = "%Y%m%d")
...
date.prev <- lubridate::ymd("20210721")
...
str.date.vacc <- "20210723" ## Optional: if not specified will take the most recent data file.
...
future.n  <- (c(1.5, 1.5, 1.5, 1.5, rep(1.5, 7)) * 10^6) * (55.98 / 66.65)
