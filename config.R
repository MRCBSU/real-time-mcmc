...
google.data.date <- format(ymd("20210827"), format = "%Y%m%d")
...
if(use.previous.run.for.start){
    if(region.type == "NHS"){
        if(str.cutoff == "60")
            previous.run.to.use <- file.path(proj.dir, "model_runs", "20210820", c("Prev473_cm6ons_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210820_timeuse_household_deaths",
                                                                                   "Prev473_cm6ons_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210820_timeuse_household_deaths_chain2")
                                             )
        else previous.run.to.use <- file.path(proj.dir, "model_runs", "20210820", c("Prev473_cm6ons_NHS28cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210820_timeuse_household_deaths_chain2",
                                                                                    "Prev473_cm6ons_NHS28cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210820_timeuse_household_deaths")
                                              )
    } else if(region.type == "ONS")
        previous.run.to.use <- file.path(proj.dir, "model_runs", "20210820", c("Prev473_cm6ons_ONS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210820_timeuse_household_deaths_chain2",
                                                                               "Prev473_cm6ons_ONS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210820_timeuse_household_deaths")
                                         )
}
...
date.prev <- lubridate::ymd("20210825")
...
future.n <- (c(1.3, 1.1, rep(1.0, 9)) * 10^6) * (55.98 / 66.65)
