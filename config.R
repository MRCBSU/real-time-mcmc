...
google.data.date <- format(ymd("2021-08-27"), format = "%Y%m%d")
...
str.date.vacc <- "20210827" ## Optional: if not specified will take the most recent data file.
...
future.n  <- (c(1.3, 1.1, 1.0, 1.0, rep(1.0, 7)) * 10^6) * (55.98 / 66.65)
