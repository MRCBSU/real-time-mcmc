...
deaths.loc <- "/home/phe.gov.uk/joel.kandiah/mcmc/real-time-mcmc/data/raw/deaths/20211217 COVID19 Deaths.csv"
vacc.loc <- "/home/phe.gov.uk/joel.kandiah/vaccination-processing-for-rtm/data/input/20211216 immunisations SPIM.csv"
str.date.vacc <- "20211216"
...
if(use.previous.run.for.start){
    if(region.type == "NHS"){
        ...
        previous.run.to.use <- file.path(proj.dir, "model_runs", "20211210", c("Prev585SeroNHSBT_All_ONS28cutoff_IFR6bp_18wk2_prev14-0PHE_matrices_20211210_timeuse_household_deaths", # _stable_household_deaths_chain2",
                                                                                      "Prev585SeroNHSBT_All_ONS28cutoff_IFR6bp_18wk2_prev14-0PHE_matrices_20211210_timeuse_household_deaths_chain2") # _stable_household_deaths")
