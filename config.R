...
google.data.date <- format(ymd("20210903"), format = "%Y%m%d")
...
if(use.previous.run.for.start){
    if(region.type == "NHS"){
        if(str.cutoff == "60")
            previous.run.to.use <- file.path(proj.dir, "model_runs", "20210827", c("Prev480_cm6ons_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210827_timeuse_household_deaths",
                                                                                   "Prev480_cm6ons_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210827_timeuse_household_deaths_chain2")
                                             )
        else previous.run.to.use <- file.path(proj.dir, "model_runs", "20210827", c("Prev480_cm6ons_NHS28cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210827_timeuse_household_deaths_chain2",
                                                                                    "Prev480_cm6ons_NHS28cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210827_timeuse_household_deaths")
                                              )
    } else if(region.type == "ONS")
        previous.run.to.use <- file.path(proj.dir, "model_runs", "20210827", c("Prev480_cm6ons_ONS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210827_timeuse_household_deaths_chain2",
                                                                               "Prev480_cm6ons_ONS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210827_timeuse_household_deaths")
                                         )
}
...
future.n <- (c(1.3, 1.3, rep(1.3, 9)) * 10^6) * (55.98 / 66.65)
