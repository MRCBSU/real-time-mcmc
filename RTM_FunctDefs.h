...
double fn_log_lik_positivity(const gsl_matrix*, const gsl_matrix*, const gsl_matrix*, const likelihood_bounds&);
double fn_log_lik_countdata(const gsl_matrix*, const gsl_matrix*, const likelihood_bounds&);
double fn_log_lik_negbindata(const gsl_matrix*, const gsl_matrix*, const gsl_matrix*, const likelihood_bounds&);
