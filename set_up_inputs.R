...
thin.outputs <- 90 ## After how many iterations to output each set of NNI, deaths etc.
thin.params <- 45 ## After how many iterations to output each set of parameters
