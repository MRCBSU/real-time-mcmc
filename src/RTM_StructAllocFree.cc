				 ...
				 const regional_model_params& src_rmp)
{
  ...
  dest_rmp.l_vacc4_disease = gsl_matrix_calloc(src_rmp.l_vacc4_disease->size1, src_rmp.l_vacc4_disease->size2);  
  ...
  dest_rmp.l_vacc4_infect = gsl_matrix_calloc(src_rmp.l_vacc4_infect->size1, src_rmp.l_vacc4_infect->size2);
...
void regional_model_params_memcpy(regional_model_params& rmp_dest, const regional_model_params& rmp_src, flagclass& update_flags)
{
  ...
  if(update_flags.getFlag("l_vacc4_disease"))
    gsl_matrix_memcpy(rmp_dest.l_vacc4_disease, rmp_src.l_vacc4_disease);
  ...
  if(update_flags.getFlag("l_vacc4_infect"))
    gsl_matrix_memcpy(rmp_dest.l_vacc4_infect, rmp_src.l_vacc4_infect);
...
void Region_free(Region& old_reg, const global_model_instance_parameters src_gmip)
{
  ...
  if(old_reg.data_owner){
    ...
    if(src_gmip.l_VFourth_data_flag) delete old_reg.VFourth_data;
  }
...
void Region_memcpy(Region& reg_dest, const Region& reg_src, flagclass& update_flags)
{
  ...
  // if(reg_src.VFourth_data != 0)
  reg_dest.VFourth_data = reg_src.VFourth_data;
