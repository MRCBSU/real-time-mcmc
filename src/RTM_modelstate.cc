...
S(NUM_AGE_GROUPS), E_1(NUM_AGE_GROUPS), E_2(NUM_AGE_GROUPS), I_1(NUM_AGE_GROUPS), I_2(NUM_AGE_GROUPS), p_lambda(NUM_AGE_GROUPS)
{}
model_state::model_state(const unsigned int iSize) :
S(iSize), E_1(iSize), E_2(iSize), I_1(iSize), I_2(iSize), p_lambda(iSize)
{}
model_state::model_state(const model_state& oC) : 
S(oC.S), E_1(oC.E_1), E_2(oC.E_2), I_1(oC.I_1), I_2(oC.I_2), p_lambda(oC.p_lambda)
{}
...
void model_state::fill(const gsl_vector* inS, const gsl_vector* inE_1, const gsl_vector* inE_2, const gsl_vector* inI_1, const gsl_vector* inI_2, const gsl_vector* inp_lambda)
{
