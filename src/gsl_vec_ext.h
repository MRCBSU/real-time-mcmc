...
void gsl_vector_sscanf(const string, gsl_vector *,
                       const char *chr_delim = ",;");
void gsl_vector_int_sscanf(const string, gsl_vector_int *,
                           const char *chr_delim = ",;");
void gsl_vector_int_set_seq(gsl_vector_int *, const int i_from = 1,
                            const int i_by = 1);
void gsl_vector_set_seq(gsl_vector *, const double dbl_from = 1.0,
                        const double dbl_by = 1.0);
