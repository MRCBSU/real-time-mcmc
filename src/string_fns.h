...
// WHEN I CAN FIGURE OUT THE CORRECT FILES TO INCLUDE, THE BELOW INCLUDE
// STATEMENT SHOULD BE REMOVED AND REPLACES WITH STANDARD C++ LIBRARIES, AND
// THIS SHOULD THEN BE PORTABLE CODE
...
template <typename D>
D read_from_delim_string(const string &, const char *, int &);
