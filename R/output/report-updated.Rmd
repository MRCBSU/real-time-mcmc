...
author: "Paul Birrell, Joshua Blake, Edwin van Leeuwen, MRC Biostatistics Unit COVID-19 Working Group, and Daniela De Angelis."
...
1. We estimate that across England there are 4,300 (2,400--7,300, 95% credible interval) new infections arising each day
1. We predict  that the number of deaths each day is likely to fall to between 60 and 90 by the end of the first week of July.
1. We estimate that it is very likely that $R_t$ is below 1 in each region of England.
1. The South West has the highest probability (30%) that $R_t$ is above 1 and a central estimate for $R_t$ of 0.94. However, the numbers of new infections occurring in this region on a daily basis is relatively low.
