...
1. We estimate that across England there are 12,000 (3,700--40,000, 95% credible interval) new infections arising each day
1. We estimate that the number of deaths each day is likely to fall to between 100-200 by mid-June
1. We believe it is highly probable that $R_t$ is below 1 in all regions of England with the exception of the South West
1. In the South West, although $R_t$ is around 1, the numbers of new infections occurring in the region on a  daily basis is relatively low
1. There is some evidence that $R_t$ has risen in all regions and we believe that this is probably due to increasing mobility and mixing between households and in public and workplace settings
1. An increase in $R_t$ will lead to a slowdown in the decrease in new infections and deaths
