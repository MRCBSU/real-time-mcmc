...
```{r ifr, eval=!is.null(deaths), message=FALSE, warning=FALSE}
ifr.start <- ifr[, , 1]
...
```{r growth-rate-func, message=FALSE}
...
```{r P-R-gt-1, cache=TRUE, cache.extra=results_hash, echo=FALSE, message=FALSE}
(Rt > 1) %>%
