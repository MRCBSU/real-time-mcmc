...
```{r eval=file.exists(file.path(out.dir, "projections/projections.RData")), child='projinf-report.Rmd'}
```

```{r eval=(as.logical(gp.flag) & file.exists(file.path(out.dir, "projections/projections.RData"))), child='projinf-cases-report.Rmd'}
```
