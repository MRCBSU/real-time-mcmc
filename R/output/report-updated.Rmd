...
1. We predict that the number of deaths each day is likely to be between 45 and 85 by the end of July.
1. We estimate it is very likely that $R_t$ is below 1 in all regions of England.
1. The East of England and the North East & Yorkshire have the highest probabilities (33% and 32% respectively) that $R_t$ is above 1. This probability is $\leq 5$% for the North West and the Midlands.
