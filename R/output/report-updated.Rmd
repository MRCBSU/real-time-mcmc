...
1. We estimate that across England, infections are down to 3,000 (1,500--5,800, 95% credible interval) new infections arising each day
1. We predict  that the number of deaths each day is likely to fall to between 35 and 70 by the middle of July.
1. We estimate that it is very likely that $R_t$ is below 1 in each region of England.
1. The Midlands has the highest probability (15%) that $R_t$ is above 1 and a central estimate for $R_t$ of 0.89. However, the numbers of new infections occurring in this region on a daily basis is relatively low.
