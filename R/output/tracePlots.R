...
<<<<<<< HEAD
var.priors <- list(distribution = list(NULL, NULL, NULL, list(dgamma), list(dgamma), NULL, list(dgamma), NULL, NULL, list(NULL, dbeta), NULL, NULL, list(dgamma), list(dnorm), NULL, NULL, list(dbeta),
||||||| parent of a3b0a9b... Correct number of priors for parameters which can change length
### PRIOR INFORMATION
var.priors <- list(distribution = list(NULL, NULL, NULL, list(dgamma), list(dgamma), NULL, list(dgamma), NULL, NULL, list(NULL, dbeta), NULL, NULL, list(dgamma), list(dnorm), NULL, NULL, list(dbeta),
=======
### PRIOR INFORMATION
...
>>>>>>> a3b0a9b... Correct number of priors for parameters which can change length
                                       list(dbeta), NULL, NULL, NULL, NULL, NULL, NULL), ## informative prior specification
                   parameters = list(NA, NA, NA, pars.eta, pars.eta.h, NA, pars.dI, NA, NA, pars.lockdown, NA, NA, pars.egr, rep(pars.nu, r), NA, NA, pars.pgp,
