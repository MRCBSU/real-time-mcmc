...
### PRIOR INFORMATION
var.priors <- list(
	distribution = list(NULL, NULL, NULL, rep(list(dgamma), gp.flag), rep(list(dgamma), hosp.flag), NULL, list(dgamma), NULL, NULL, rep(list(NULL, dbeta, dbeta), r), NULL, NULL, rep(list(dgamma), r), rep(list(dnorm), r), NULL, NULL, rep(list(dbeta), nA - 1), rep(list(dbeta), nA - 1), NULL, NULL, NULL, NULL, NULL, NULL), ## informative prior specification
