...
var.priors <- list(distribution = list(NULL, NULL, NULL, rep(list(dgamma), gp.flag), rep(list(dgamma), hosp.flag), NULL, list(dgamma), NULL, NULL,
                                       ...
                                       rep(list(dbeta), nA - 1), NULL, NULL, NULL, NULL, NULL, list(dbeta), list(dbeta), NULL), ## informative prior specification
                   parameters = list(NA, NA, NA, pars.eta, pars.eta.h, NA, pars.dI, NA, NA, contact.pars, NA, NA, pars.egr, rep(pars.nu, r), NA, NA, NA,
                                     pars.ifr, NA, NA, NA, NA, NA, ssens.prior.pars, sspec.prior.pars, NA)
                   )
