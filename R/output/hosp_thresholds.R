...
output.dir <- file.path(proj.dir, "model_runs", "20211022", "Prev536SeroNHSBT_All_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20211022_stable_household_deaths_chain2")
...
beds.day <- lubridate::as_date("20211021")
