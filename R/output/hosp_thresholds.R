...
output.dir <- file.path(proj.dir, "model_runs", "20210904", "Prev487_cm6ons_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20210903_timeuse_household_deaths")
...
beds.day <- lubridate::as_date("20210902")
