...
output.dir <- file.path(proj.dir, "model_runs", "20210813", "Prev466_cm6ons_NHS60cutoff_IFR4bp_18wk2_prev14-0PHE_matrices_20210813_timeuse_household_deaths")
...
beds.day <- lubridate::as_date("20210812")
