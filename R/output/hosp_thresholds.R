...
output.dir <- file.path(proj.dir, "model_runs", "20211015", "Prev529SeroNHSBT_1stwv_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20211015_stable_household_deaths_chain2")
