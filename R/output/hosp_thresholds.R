...
output.dir <- file.path(proj.dir, "model_runs", "20211119", "Prev564SeroNHSBT_All_NHS60cutoff_IFR5bp_18wk2_prev14-0PHE_matrices_20211119_timeuse_household_deaths")
...
beds.day <- lubridate::as_date("20211118")
