...
tbl_raw <- read_csv(
	"https://api.coronavirus.data.gov.uk/v1/data?filters=areaName=Northern%20Ireland&structure={%22areaName%22:%22areaName%22,%22date%22:%22date%22,%22newDeaths28DaysByDeathDate%22:%22newDeaths28DaysByDeathDate%22,%22newDeaths28DaysByPublishDate%22:%22newDeaths28DaysByPublishDate%22}&format=csv",
	col_types = cols(
...
stopifnot(all(tbl_raw$areaName == "Northern Ireland"))
