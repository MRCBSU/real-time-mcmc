...
study_region = { regions_used = `r paste(regions, collapse = ", ")`;
		 ...
		 regions_1stvaccination_data = `r ifelse(vacc.flag, paste(vacc1.files, collapse = ", "), "NULL")`;
		 regions_2ndvaccination_data = `r ifelse(vacc.flag, paste(vacc2.files, collapse = ", "), "NULL")`;
