...
proposal_variance = `r paste(c(0, rep(0.001, length(contact.reduction) - 1)), collapse = ", ")`;

proposal_variance = 0.1, 0.1;
...
log_p_lambda_0 = { param_value = `r paste(rnorm(nregs, pars.nu[1], pars.nu[2]), collapse = ", ")`;
