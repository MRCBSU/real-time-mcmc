negbin_overdispersion = { param_value = `r value.eta`;
...
<br>
<br>
log_p_lambda_0 = { param_value = `r value.nu`;

prior_distribution = 4;

prior_parameters = `r paste(pars.nu, collapse = ", ")`;
...
<br>
<br>
prop_case_to_hosp = { param_value = 0.05;
...
<br>
<br>
gp_reporting_distribution = { gamma_mean = 8.54;
...
<br>
<br>
hosp_reporting_distribution = { gamma_mean = 8.54;
