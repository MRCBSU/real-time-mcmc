...
value.egr <- c(0.266386412775556, 0.231040986029484, 0.235589106443936, 0.305950653647048, 0.282526430208455, 0.216668361008301, 0.222294770391012)[1:nr]
...
## Initial seeding
value.nu <- c(-16.2719920280182, -13.7528046318741, -15.0958323138269, -17.6712207723268, -16.6386535187948, -14.9096259051349, -15.9902773129261)[1:nr]
pars.nu <- c(-17.5, 1.25)
...
## }
contact.proposal <- c(0.0, 0.003313, 0.000031, 0.000564, 0.0, 0.000714, 0.000077, 0.002036, 0.0, 0.001323, 0.000022, 0.000406, 0.0, 0.008052, 0.000020, 0.000216, 0.0, 0.004521, 0.000023, 0.000421, 0.0, 0.001625, 0.000035, 0.000356, 0.0, 0.005989, 0.000097, 0.000872)[1:length(contact.dist)]
...
beta.rw.vals <- c(0, -0.0642613930028543, 0.137470227612429, 0.18203661462353, 0.208765769249931, -0.285692841926755, -0.0299902301756172, -0.137239973812927, -0.128225668742848, -0.248624010808639, 0, 0, 0,
                  ...
                  0, -0.12394074164419, -0.0943171828153658, 0.0563763749693666, -0.0187639431158053, 0.331927977648457, -0.26183947078463, 0.1536281048271, -0.0961824810293474, 0.112915829534447, 0, 0, 0)[1:nbetas]
beta.update <- TRUE
beta.rw.flag <- TRUE
...
beta.rw.props <- c(0.0, 0.000026, 0.000050, 0.000041, 0.000104, 0.000272, 0.000507, 0.001690, 0.004086, 0.013020, 0.01, 0.01, 0.01,
                   ...
                   0.0, 0.000075, 0.000084, 0.000121, 0.000243, 0.000402, 0.000800, 0.003132, 0.007688, 0.010336, 0.01, 0.01, 0.01)[1:nbetas]
