...
rtm_gnu_empirical_debug	: build/RTM_RegRTM_Beta3.0DEBUG.o build/RTM_Inputs.o build/RTM_StructAllocFree.o build/RTM_MixingMatrices.o build/RTM_WithinRegion_empirical.o build/RTM_Likelihoods_empiricalDEBUG.o build/RTM_MetropHast.o build/RTM_flagclass.o build/RTM_MvNorm.o build/gp_param_patch.o build/R_like_fns.o build/file_string_fns.o build/string_fns.o build/gsl_vector_exts.o build/gsl_matrix_exts.o src/distributions.h src/gsl_mat_ext.h src/gsl_vec_ext.h src/R_like_fns.h src/RTM_flagclass.h src/RTM_FunctDefs.h src/RTM_Header.h src/RTM_StructAssign.h src/RTM_StructDefs.h src/string_fns.h src/RTM_modelstate.h build/RTM_modelstate.o build/rtm_data_class.o src/rtm_data_class.h src/stl_vec_ext.h build/stl_vector_exts.o src/I0_patch.h build/I0_patch.o
	$(CXX) $^ $(LDFLAGS) $(LOADLIBES) $(LDLIBS) -o rtm_gnu_empirical_debug

rtm_gnu_empirical	: build/RTM_RegRTM_Beta3.0.o build/RTM_Inputs.o build/RTM_StructAllocFree.o build/RTM_MixingMatrices.o build/RTM_WithinRegion_empirical.o build/RTM_Likelihoods_empirical.o build/RTM_MetropHast.o build/RTM_flagclass.o build/RTM_MvNorm.o build/gp_param_patch.o build/R_like_fns.o build/file_string_fns.o build/string_fns.o build/gsl_vector_exts.o build/gsl_matrix_exts.o src/distributions.h src/gsl_mat_ext.h src/gsl_vec_ext.h src/R_like_fns.h src/RTM_flagclass.h src/RTM_FunctDefs.h src/RTM_Header.h src/RTM_StructAssign.h src/RTM_StructDefs.h src/string_fns.h src/RTM_modelstate.h build/RTM_modelstate.o build/rtm_data_class.o src/rtm_data_class.h src/stl_vec_ext.h build/stl_vector_exts.o src/I0_patch.h build/I0_patch.o
	$(CXX) $^ $(LDFLAGS) $(LOADLIBES) $(LDLIBS) -o rtm_gnu_empirical
