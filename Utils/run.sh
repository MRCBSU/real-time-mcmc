...
select script_opt in "Pre-process" "Run Model" "Profile Model" "Post-process" "Simulate" "Projections Report" "Save Endstates" "Restart Runs" "Calculate Eigenvecs" "Exit to Shell"
do
    case $script_opt in
        ...
        "Profile Model")
            export RUN_NAME="Run model"
            export SLURM_LOC=$ROOT_DIR/submission_scripts/submit_cu_hpc_profile
            break
            ;;
        ...
        "Calculate Eigenvecs")
            export RUN_NAME="Calculate Eigenvecs"
            export SLURM_LOC=$ROOT_DIR/submission_scripts/submit_eigenvec
            break
            ;;
...
case $script_opt in
    ...
    "Run Model" | "Profile Model" | "Post-process" | "Simulate" | "Projections Report" | "Save Endstates" | "Restart Runs" | "Calculate Eigenvecs")
