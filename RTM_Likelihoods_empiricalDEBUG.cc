			   ...
			   model_statistics& mod_stats)
{
  ...
  // HACK!!! ARBITRARILY SET THE INITIAL DISTRIBUTION - FIXED IRRESPECTIVE OF THE PARAMETERS - IS THIS A GOOD IDEA?
  I0_patch(*in_dmp.l_MIXMOD.evector_MIXMAT_normalised);
